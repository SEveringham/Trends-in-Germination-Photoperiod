...
- see Rmarkdown "" for gaining a photoperiod sensitivity index for each species using bayesian GLMs
- see Rmarkdown file "" for Phylogenetic Analyses of photoperiod sensitivity across our species
- see Rmarkdown file "" for main analysis of germination photoperiod sensitivity and it's relationship with all environmental/ecological predictor variables
...
```{r}
latitudemodelLDSD <- glm(OverallPS~photoperiodism + lat + photoperiodism * lat, family = gaussian(link = "identity"), data =globalfloweringphotoperiod)
...
```{r}
seedmassmodelLDSD <- glm(OverallPS~photoperiodism + seed_mass + photoperiodism * seed_mass, family = gaussian(link = "identity"), data =globalfloweringphotoperiod)
...
```{r}
LAILDSD <- glm(OverallPS~photoperiodism + LAI + photoperiodism * LAI, family = gaussian(link = "identity"), data =globalfloweringphotoperiod)
...
#FLOWERING PHOTOPERIOD AND ALPINE ENVIRONMENT 
